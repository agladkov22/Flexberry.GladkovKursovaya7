...
namespace IIS.Gladkov_Kursovaya
{
    ...
    public class Материалы : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Gladkov_Kursovaya.Склады fСклады;
        ...
        [PropertyStorage(new string[] {
                "Склады"})]
        [NotNull()]
        public virtual IIS.Gladkov_Kursovaya.Склады Склады
        {
            get
            {
                ...
                IIS.Gladkov_Kursovaya.Склады result = this.fСклады;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МатериалыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалыE", typeof(IIS.Gladkov_Kursovaya.Материалы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МатериалыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалыL", typeof(IIS.Gladkov_Kursovaya.Материалы));
                }
            }
        }
    }

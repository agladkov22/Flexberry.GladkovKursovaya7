...
moduleForModel('i-i-s-gladkov-kursovaya-оборудование', 'Unit | Serializer | i-i-s-gladkov-kursovaya-оборудование', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gladkov-kursovaya-оборудование',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',

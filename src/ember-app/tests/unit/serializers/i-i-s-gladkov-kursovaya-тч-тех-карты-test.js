...
moduleForModel('i-i-s-gladkov-kursovaya-тч-тех-карты', 'Unit | Serializer | i-i-s-gladkov-kursovaya-тч-тех-карты', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-gladkov-kursovaya-тч-тех-карты',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
